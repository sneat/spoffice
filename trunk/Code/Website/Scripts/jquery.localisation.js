...
$.localise = function(packages, settings, loadBase, path, timeout) {
	...
	var saveSettings = {async: $.ajaxSettings.async, timeout: $.ajaxSettings.timeout, success : settings.callback};
	...
	$.ajaxSetup({async: false, timeout: (settings.timeout || 500), success : settings.callback});
