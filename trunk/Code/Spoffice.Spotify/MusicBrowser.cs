...
namespace Spoffice.Spotify
{
    public class MusicBrowser : IMusicBrowser
    {
        ...
        {
            string cachePath = String.Format("{1}{0}{2}{0}{3}{0}{4}{0}{5}.xml", Path.DirectorySeparatorChar, CacheHelper.CachePath, "spotify", "requests", folder, id);
            XDocument data;
            ...
            else
            {
                ...
                CacheHelper.CreateFolder(cachePath);
                data.Save(cachePath);
            }
            return data;
        }
