...
namespace SharpSpotLib.Util
{
    internal class SpotifyOggHeader
    {
        ...
        private Int32 _unknown = 0;
        private readonly Int32[] _headerTableDec = new Int32[] {
        ...
        public Int32 GetLength(Int32 sampleRate)
        {
        ...
        /* Swap integer bytes. */
        private Int32 Swap(Int32 value)
        {
            Byte[] inBytes = IntegerUtilities.ToBytes(value);
            return IntegerUtilities.BytesToInteger(
	    ...
	    private void Decode(Byte[] header)
        {
		    ...
		    if (input.GetByte() == 0x81)
            {
                ...
                {
				    Int32 blockSize = this.Swap(input.GetShort());
					    ...
					    switch (input.GetByte())
                        {
						    ...
						    case 0:
							    if (blockSize == 0x6e)
                                {
								    ...
								    this.Table   = new Int32[0x64];
    								
								    Int32 ack = this._unknown;
								    Int32 ctr = 0;
						    ...
						    case 1:
							    if(blockSize > 0x10)
                                {
                                    ...
                                    {
									    this.GainDb = SingleUtilities.IntBitsToFloat(value);
								    }
